        ...
        <script>
            ...
            function validatePassword() {
                ...
                if (!isValid) {
                    displayErrorMessage(
                            "password",
                            "Password contain at least one digit, lowercase letter, uppercase letter, and special character and at least 8 letters"
                            );
                } else {
        ...
        <div class="container mt-5">
            ...
            <form action="addpatient" method="post" >
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="id" name="id" class="form-control" maxlength="9" required onblur="validateId()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="username" name="username" class="form-control" maxlength="20" required onblur="validateUsername()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="password" id="password" name="password" class="form-control" maxlength="20" required onblur="validatePassword()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="fullName" name="fullName" class="form-control" maxlength="20" required onblur="validateFullName()">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="address" name="address" class="form-control" maxlength="50" required onblur="validateAddress()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="phone" name="phone" class="form-control" maxlength="10" required onblur="validatePhone()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="date" name="dob" id="dob" class="form-control" required onblur="validateDOB()">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    ...
                    <button type="button" onclick="location.href = 'pagingpatient'" class="btn btn-secondary">Cancel</button>
                </div>
            </form>
