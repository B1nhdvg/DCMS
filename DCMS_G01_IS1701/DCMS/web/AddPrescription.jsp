...
<html lang="en">
    ...
    <head>
        ...
        <title>Create a Prescription</title>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h1 class="mb-4">Create new prescription</h1>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="materialName" name="materialName" class="form-control"  required maxthlenth="20">
                                <span id="materialNameError" class="error-message position-absolute"></span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="date" name="date" id="date" class="form-control" required onblur="validateDate()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="note" name="note" class="form-control" required maxlength="50">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" id="unit" name="unit" class="form-control" required maxthlenth="10">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="number" id="amount" name="amount" class="form-control"  required onblur="validateAmount()">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Do you want to create this Prescription?
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-primary" onclick="location.href = 'createprescription?aid=${examination_result.apId}'">Confirm</button>
                                </div>
                            </div>
                        </div>
                    </div>
