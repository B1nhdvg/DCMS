...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            <h1 class="mb-4">Update Patient</h1>
            <form action="updatepatient" method="post" onsubmit="return validateForm()">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="radio" id="male" name="gender" value="True" class="form-check-input" ${st.getGender() == "Male" ? "checked" : ""}>
                            <label for="male" class="form-check-label">Male</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" id="female" name="gender" value="False" class="form-check-input" ${st.getGender() == "Female" ? "checked" : ""}>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    ...
                    <button type="button" onclick="location.href = 'pagingpatient'" class="btn btn-secondary">Back</button>
                </div>
            </form>
        </div>

        <!-- Inside UpdateEmployee.jsp -->
