 ...
 * @author nmcbo
 */
public class ViewDetailPrescriptionController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewPrescriptionDetailController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewPrescriptionDetailController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("appointmentId",e.getApId());
        request.getRequestDispatcher("DetailPrescription.jsp").forward(request, response);
    } 
