...
public class Validator {
    ...
    public boolean getUsername(String username) {
        // Kiểm tra xem username có tồn tại, không rỗng, không vượt quá 20 ký tự và chỉ chứa chữ cái và số không
        return username != null && !username.trim().isEmpty() && username.trim().length() <= 20 && username.matches("^[a-zA-Z0-9]+$");
    }
